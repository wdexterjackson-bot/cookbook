...
struct EntitlementGrantingTests {
    ...
    @Test func fakeGranterGrantsOncePerUser() async throws {
        ...
        try await granter.grantPromoCreditsIfEligible(userID: "uid-1", now: eligibleDate)
        try await granter.grantPromoCreditsIfEligible(userID: "uid-1", now: eligibleDate)
    ...
    @Test func fakeGranterSkipsIneligibleDates() async throws {
        ...
        try await granter.grantPromoCreditsIfEligible(userID: "uid-1", now: ineligibleDate)
